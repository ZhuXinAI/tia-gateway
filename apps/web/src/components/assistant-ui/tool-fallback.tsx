...
type ToolFallbackRootProps = Omit<ComponentProps<typeof Collapsible>, 'open' | 'onOpenChange'> & {
  open?: boolean
...
function ToolFallbackRoot({
  ...
  children,
  ...props
}: ToolFallbackRootProps): JSX.Element {
...
function ToolFallbackContent({
  ...
  children,
  ...props
}: ComponentProps<typeof CollapsibleContent>): JSX.Element {
  return (
    <CollapsibleContent
      data-slot="tool-fallback-content"
      className={cn(
        'aui-tool-fallback-content group/collapsible-content relative overflow-hidden text-sm outline-none ease-out',
